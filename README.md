...
In Control for Commercial Payments (ICCP) streamlines business
...
The Mastercard Send Disbursements services enable registered Program
...
- [Tutorials](
https://developer.mastercard.com/match/documentation/tutorial-structure/)
...
- [PostmanCollection](
https://developer.mastercard.com/match/documentation/postman-collection/)
...
Simplifies the development of Mastercard Cloud-Based Payments (MCBP)
applications for Android and iOS devices View documentation 
...
The Mastercard Digital Enablement Service (MDES) On-Behalf-Of (OBO) model
for merchants allows Payment Service Providers (PSP) to perform
Tokenization and Transaction activities for the merchants they represent.
A PSP operating in this model is referred to as an On-behalf-Of Token
Requestor (OBOTR) and the merchant they support is described as the Token
Requestor.

**Human URL:** [
https://developer.mastercard.com/token-requestor-identifier-api/documentation/](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/)
...
- [GettingStarted](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/getting-started/)
- [Authentication](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/api-basics/#authentication-requirements)
- [Environments](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/api-basics/#environment-domains)
- [UseCases](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/use-cases/)
- [Tutorials](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/tutorials-and-guides/)
- [Documentation](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/api-reference/)
- [Errors](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/code-and-formats/)
- [Testing](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/testing/)
- [FAQ](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/support/#faqs)
- [Support](
https://developer.mastercard.com/token-requestor-identifier-api/documentation/support/#get-help)
...
- [ChangeLog](
https://developer.mastercard.com/mdes-digital-enablement/documentation/release-notes/)
- [GettingStarted](
https://developer.mastercard.com/mdes-digital-enablement/documentation/getting-started/)
- [Authentication](
https://developer.mastercard.com/mdes-digital-enablement/documentation/api-basics/#authentication)
- [ Encryption](
https://developer.mastercard.com/mdes-digital-enablement/documentation/api-basics/#encryption)
- [Environments](
https://developer.mastercard.com/mdes-digital-enablement/documentation/api-basics/#environment-descriptions)
- [UseCases](
https://developer.mastercard.com/mdes-digital-enablement/documentation/use-cases/)
- [Environments](
https://developer.mastercard.com/mdes-digital-enablement/documentation/environment-domains/#global)
- [Documentation](
https://developer.mastercard.com/mdes-digital-enablement/documentation/api-reference/)
- [Tutorials](
https://developer.mastercard.com/mdes-digital-enablement/documentation/tutorials/)
- [Errors](
https://developer.mastercard.com/mdes-digital-enablement/documentation/code-and-formats/)
- [Support](
https://developer.mastercard.com/mdes-digital-enablement/documentation/support/#faq)
- [FAQ](
...
- [Overview](
https://developer.mastercard.com/authentication-facilitator/documentation/)
- [ChangeLog](
...
significant implications for the payments industry in Mexico. This move
...
different Mastercard systems. The PAM API can be used to submit lifecycle
management events that update associated Mastercard Digital Enablement
...
introduced the industry-wide solution to address merchant and acquirer
...
patterns and matches them with suitable offers, enhancing the customer
